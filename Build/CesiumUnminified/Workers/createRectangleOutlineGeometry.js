...
define(['./when-208fe5b0', './Cartesian2-716c2715', './GeometryOffsetAttribute-d63c288d', './Transforms-749d0f94', './ComponentDatatype-549ec0d3', './Check-d18af7c4', './GeometryAttribute-3fb8f432', './GeometryAttributes-b0b294d8', './IndexDatatype-d9b71b2b', './Math-3ba16bed', './PolygonPipeline-8b9b046d', './RectangleGeometryLibrary-1bc521b3', './RuntimeError-7f634f5d', './WebGLConstants-76bb35d1', './EllipsoidRhumbLine-886cd793'], function (when, Cartesian2, GeometryOffsetAttribute, Transforms, ComponentDatatype, Check, GeometryAttribute, GeometryAttributes, IndexDatatype, _Math, PolygonPipeline, RectangleGeometryLibrary, RuntimeError, WebGLConstants, EllipsoidRhumbLine) { 'use strict';
