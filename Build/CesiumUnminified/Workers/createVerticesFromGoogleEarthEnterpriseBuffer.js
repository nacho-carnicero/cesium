...
define(['./EllipsoidTangentPlane-6242a111', './Transforms-749d0f94', './Cartesian2-716c2715', './when-208fe5b0', './TerrainEncoding-bc1ac4e6', './Math-3ba16bed', './OrientedBoundingBox-96f0dda0', './RuntimeError-7f634f5d', './WebMercatorProjection-3b6236c8', './createTaskProcessorWorker', './Check-d18af7c4', './IntersectionTests-64305b2d', './Plane-fa9c3435', './AttributeCompression-69c5b20c', './ComponentDatatype-549ec0d3', './WebGLConstants-76bb35d1'], function (EllipsoidTangentPlane, Transforms, Cartesian2, when, TerrainEncoding, _Math, OrientedBoundingBox, RuntimeError, WebMercatorProjection, createTaskProcessorWorker, Check, IntersectionTests, Plane, AttributeCompression, ComponentDatatype, WebGLConstants) { 'use strict';
